...
require_once __DIR__ .'/../model/modelRabview.php';
require_once __DIR__ .'/../model/modelVolume.php';
require_once __DIR__ .'/../model/modelPengguna.php';
require_once __DIR__ .'/../model/modelTriwulan.php';
...
$rab      = new modelRab();
$rabview  = new modelRabview();
$volume  = new modelVolume();
$pengguna = new modelPengguna();
$report   = new modelReport();
$triwulan = new modelTriwulan();
